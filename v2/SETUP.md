...
do $$ declare t text;
begin
  foreach t in array array['team','accounts','profiles','products','concepts','stages','scripts','script_entries','daily_entries','daily_hooks'] loop
...
-- ---------- live sync ----------
alter publication supabase_realtime add table team, accounts, profiles, products, concepts, stages, scripts, script_entries, daily_entries, daily_hooks;
