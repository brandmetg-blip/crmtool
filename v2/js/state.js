...
export const state = {
  ...
  postMonth: null,            // posting calendar: YYYY-MM shown (poster)
  posterView: 'list',         // poster's builder: 'list' (rows) | 'cards'
  ...
  acctView: 'roster',         // avatars tab: roster (live + setting up) | archive
